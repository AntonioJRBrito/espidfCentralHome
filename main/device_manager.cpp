...
namespace DeviceManager{
    ...
    #define OLED_I2C_SDA     GPIO_NUM_16
    ...
    // devices
    static const gpio_num_t OUTPUT_DEV[4]={GPIO_NUM_41,GPIO_NUM_39,GPIO_NUM_40,GPIO_NUM_42};
    ...
    static void init_backlight(){
        ...
        ESP_LOGI(TAG, "Backlight inicializado");
    }
