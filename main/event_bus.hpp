...
enum class EventId : int32_t {
    READY_ALL,
    NET_READY,NET_APDISCONNECTED,NET_APCONNECTED,NET_STADISCONNECTED,NET_STACONNECTED,NET_STASTARTED,NET_STAGOTIP,NET_APCLICONNECTED,NET_APCLIDISCONNECTED,
    RTC_READY,
    DEV_READY,
    DNS_READY,
    SOC_READY,
