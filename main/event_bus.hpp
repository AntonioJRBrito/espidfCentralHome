...
enum class EventDomain : uint8_t {NETWORK,READY,DEVICE,SOCKET,WEB,UDP,BROKER,MQTT,MATTER,AUTOMATION,OTA,STORAGE,BLE};
enum class EventId : int32_t {
    READY_ALL,
    NET_READY,NET_APDISCONNECTED,NET_APCONNECTED,NET_IFOK,NET_TESTFAILED,NET_TESTSUCCESS,NET_LISTQRY,NET_LISTOK,NET_LISTFAIL,
    NET_STADISCONNECTED,NET_STACONNECTED,NET_STASTARTED,NET_STAGOTIP,NET_APCLICONNECTED,NET_APCLIDISCONNECTED,
    RTC_READY,
    DEV_READY,
