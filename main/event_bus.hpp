...
enum class EventId : int32_t {
    ...
    NET_TESTFAILTRY,NET_TESTFAILREVERT,NET_SUSPCLIENT,NET_RTCSYNCED,NET_RTCREQUEST,NET_RTCSUPLY,NET_RTCNOSYNCED,
    RTC_READY,
    DEV_READY,
    SOC_READY,SOC_STARTED,
    WEB_READY,WEB_STARTED,WEB_STOPCLIENT,
    UDP_READY,
    BRK_READY,BRK_DEVICERECEIVED,BRK_SENSORRECEIVED,BRK_SENSORACT,BRK_PUBLISHREQUEST,
    MQT_READY,
    MTT_READY,
    AUT_READY,
    OTA_READY,
