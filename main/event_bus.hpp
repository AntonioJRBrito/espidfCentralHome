...
enum class EventId : int32_t {
    NONE=0,READY_ALL,
    NET_READY,NET_APDISCONNECTED,NET_APCONNECTED,NET_IFOK,NET_TEST,NET_TESTSUCCESS,NET_LISTQRY,NET_LISTOK,NET_LISTFAIL,
    ...
    AUT_READY,
    OTA_READY,
    STO_READY,STO_SSIDOK,STO_QUERY,STO_UPDATE,STO_CONFIGSAVED,
    BLE_READY
};
